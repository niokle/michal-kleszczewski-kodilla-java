...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf0Books() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Leon", "Witt", "12345678901");
        List<Book> resultBookList = new ArrayList<>();
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultBookList);
        //When
        int numberOfBooks = bookLibrary.listBooksInHandsOf(libraryUser).size() ;
        //Then
    ...
    public void testListBooksInHandsOf1Book() {
        ...
        LibraryUser libraryUser = new LibraryUser("Leon", "Witt", "12345678901");
        List<Book> resultBookList = new ArrayList<>();
        resultBookList = generateListOfNBooks(1);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultBookList);
        //When
        int numberOfBooks = bookLibrary.listBooksInHandsOf(libraryUser).size() ;
        //Then
        Assert.assertEquals(1, numberOfBooks );
    }
    ...
    public void testListBooksInHandsOf5Books() {
        ...
        LibraryUser libraryUser = new LibraryUser("Leon", "Witt", "12345678901");
        List<Book> resultBookList = new ArrayList<>();
        resultBookList = generateListOfNBooks(5);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultBookList);
        //When
        int numberOfBooks = bookLibrary.listBooksInHandsOf(libraryUser).size() ;
        //Then
